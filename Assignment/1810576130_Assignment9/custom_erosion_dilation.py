...
# start from here
img_path = '/home/kawsar/Desktop/Class_Resource/4th year 1st semester/4181- Digital Image Processing/ImageProcessingLab/Assignment/1810576130_Assignment9/A.png'
...
List.append([img_erosion,'Built in erosion Image'])
#custom dilation
custom_erosion = erosion(img, kernel1)
List.append([custom_erosion,'Custom erosion Image'])
